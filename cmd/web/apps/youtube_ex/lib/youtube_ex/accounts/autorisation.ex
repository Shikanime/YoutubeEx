defmodule YoutubeEx.Accounts.Autorisation do
  use Ecto.Schema
  ...
  def changeset(autorisation, attrs) do
    autorisation
    |> cast(attrs, [:update_video, :delete_video, :create_video_format, :comment_video, :update_user, :delete_user, :create_video])
    |> validate_required([:update_video, :delete_video, :create_video_format, :comment_video, :update_user, :delete_user, :create_video])
  end
end
